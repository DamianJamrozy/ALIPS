	...
	<div id="board">
		<div class="formShips">
			...
			<form method="POST" onsubmit="return validateShips()" action="set_ship.php">
				<input name="keyToHostGame" type="number" min="0" placeholder="Klucz rozgrywki" class="outShip" pattern="[^&#39;&#34;&#783;&#757;&#96;&#x60;=()/><\][\\\x22,;:|]+"  onclick=validateForm() required ><br>
				<input type="submit" class="inShip" name="joinGame" value="Dołącz" onclick=validateForm()><br>
			</form>
			<br><br>
				Utwórz grę
				<br>
